...
from schemas.categories import CategoryResponse, CategoryCreate, CategoryBase
...
@category_router.get("/", status_code=status.HTTP_200_OK, response_model=CategoryResponse)
...
@category_router.post("/category", status_code=status.HTTP_200_OK, response_model=CategoryResponse)
